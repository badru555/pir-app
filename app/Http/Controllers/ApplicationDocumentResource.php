...
class ApplicationDocumentResource extends Controller
{
    ...
    {
        // $documentobservationrisk_ids = explode(',', $applicationdocument->documentobservationrisk_ids);
        // foreach ($documentobservationrisk_ids as $val) {
        //     $documentobservationrisk = Documentobservationrisk::find($val)->first();
        //     $ids = explode(',', $documentobservationrisk->documentobservationriskactivity_ids);
        //     Documentobservationriskactivity::destroy($ids);
        // }
        // Documentobservationrisk::destroy($documentobservationrisk_ids);

        // $documentprojectrisk_ids = explode(',', $applicationdocument->documentprojectrisk_ids);
        // foreach ($documentprojectrisk_ids as $val) {
        //     $documentprojectrisk = Documentprojectrisk::find($val)->first();
        //     $ids = explode(',', $documentprojectrisk->documentprojectriskactivity_ids);
        //     foreach ($ids as $val_id) {
        //         $documentprojectriskactivity = Documentprojectriskactivity::find($val_id)->first();
        //         $subids = explode(',', $documentprojectriskactivity->documentprojectriskactivitymigitation_ids);
        //         Documentprojectriskactivitymigitation::destroy($subids);
        //     }
        //     Documentprojectriskactivity::destroy($ids);
        // }
        // Documentprojectrisk::destroy($documentprojectrisk_ids);

        Applicationdocument::destroy($applicationdocument->id);
        return redirect('applicationdocuments')->with('message', 'Berhasil dihapus!');
    }
}
